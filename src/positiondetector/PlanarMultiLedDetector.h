...
#ifndef OAT_PLANARMULTILEDDETECTOR_H
#define	OAT_PLANARMULTILEDDETECTOR_H
 ...
 */
class PlanarMultiLedDetector : public PositionDetector {
public:
     ...
     */
    PlanarMultiLedDetector(const std::string &frame_source_address,
...
void PlanarMultiLedDetectorMinAreaSliderChangedCallback(int value, void *);
void PlanarMultiLedDetectorMaxAreaSliderChangedCallback(int value, void *);
void PlanarMultiLedDetectorErodeSliderChangedCallback(int value, void *);
void PlanarMultiLedDetectorDilateSliderChangedCallback(int value, void *);

}       /* namespace oat */
#endif	/* OAT_PLANARMULTILEDDETECTOR_H */
